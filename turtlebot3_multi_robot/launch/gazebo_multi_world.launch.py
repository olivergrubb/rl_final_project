...
def generate_launch_description():
    ...
    # Add Evading Robots (Blue)
    for i in range(EVADERS):
        name = "turtlebot_evader_" + str(i)
        namespace = "/evader" + str(i)
        ...
        spawn_turtlebot3_burger = Node(
            ...
            arguments=[
                "-file",
                os.path.join(turtlebot3_multi_robot,"models", "turtlebot3_evader_" + TURTLEBOT3_MODEL, "model.sdf"),
                "-entity",
                name,
                "-robot_namespace",
                namespace,
    ...
    # Add Chasing Robots (Red)
    for i in range(CHASERS):
        name = "turtlebot_chaser" + str(i)
        namespace = "/chaser" + str(i)
        ...
        spawn_turtlebot3_burger = Node(
            ...
            arguments=[
                "-file",
                os.path.join(turtlebot3_multi_robot,"models", "turtlebot3_chaser_" + TURTLEBOT3_MODEL, "model.sdf"),
                "-entity",
                name,
                "-robot_namespace",
                namespace,
